// time handle
export function initTime(time,fontSize, numWidth, numHeight, lineWidth) {
  ...
  front.width = back.width = time.clientWidth * ratio;
  front.height = back.height = time.clientHeight;
